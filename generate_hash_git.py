...
enc  = EncryptPassword("admin", "admin", algorithm = "scram-sha-256", salt_length = 24, inerations = 4096)

enc._encrypt_scram_sha_256(hashlib.sha256, salt_length = 24, inerations = 4096)